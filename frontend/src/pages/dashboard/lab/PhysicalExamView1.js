...
//           <thead>
//             <tr>
//             <th className="px-2 py-2"><h1 className="font-bold">Exam_id</h1></th>
...
//               .map((exam, index) => (
//                 <tr key={index}>
//                                     <td className="border px-2 py-2">{exam.exam_id}</td>
...
//                   <td className="border px-2 py-2">{new Date(exam.dod).toLocaleString('en-ET', 
//                   { timeZone: 'Africa/Addis_Ababa', year: 'numeric', month: 'long', day: 'numeric' })}</td>

//                   <td className="border px-2 py-2">{exam.time}</td>

//                   <td className="grid grid-cols-3 border px-2 py-2">
