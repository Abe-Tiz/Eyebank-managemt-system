...
const HeaderComponent = ({
    ...
    const handleNavigation = () => {
      navigate(`/${route}/${role}`, { state: { role: role } });
    };
    // console.log("image:",image)
   
    return (
      <div
        className={`bg-base-200  p-2 flex justify-between text-center items-center fixed z-50  md:pr-5 pr-10  ${
          state.collapsed ? ` md:w-11/12 w-1/2 ml-8` : `md:w-4/5 w-1/2 `
        }`}
      >
        ...
        <div className=" flex items-center justify-center space-x-4">
          <div className="flex-none gap-2">
            ...
            <div className="dropdown dropdown-end ">
              ...
              >
                <li>
                  <a onClick={handleNavigation}> Profile</a>
                </li>
                <li>
                  <a onClick={() => handleLogout(role)}>
