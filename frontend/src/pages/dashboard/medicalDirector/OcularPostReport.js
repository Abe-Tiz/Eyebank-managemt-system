...
const OcularPostReport = () => {
  ...
  const currentRecipients = recipient.slice(indexOfFirstItem, indexOfLastItem);
    ...
    const getAllRecipients = async () => {
      try {
        ...
        const response = await axios.get(
          "https://eyebank-backend-2.onrender.com/recipient/getocular-repo"
        );
...
export default OcularPostReport;
