                      ...
                      <div className="col-sm-6 col-md-8 ">
                        ...
                        <div className="form-group text-center ">
                          {/* <button
                            ...
                            className="bg-green hover:bg-gray-300 text-white hover:text-green text-xl font-bold mt-3 mr-5 px-5 py-2 "
                          ...
                          <ButtonComponent title={t("contact:sendmessage")} />
                        </div>
                      </div>
