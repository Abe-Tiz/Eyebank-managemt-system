    ...
    const ReportTable = ({ data, distrData, pledData, transplantedData }) => {
    const months = [
        "January",
        "February",
        "March",
    ...
    const hasNonZeroCount = (month) => {
        ...
        findCountByMonth(transplantedData, month) > 0
        );
    };
            ...
            {months.map(
                ...
                hasNonZeroCount(month) && (
                    ...
                    <td className="px-6 py-4">
                        {findCountByMonth(distrData, month)}
                    </td>
                    <td className="px-6 py-4">
                        {findCountByMonth(pledData, month)}
                    </td>
                    <td className="px-6 py-4">
                        {findCountByMonth(transplantedData, month)}
                    </td>
                    </tr>
                )
            )}
